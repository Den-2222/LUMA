...
**Домен.** DigitalOcean доменів не продає, але керує DNS безкоштовно. Якщо домен уже десь є — або додай у реєстратора A-запис `groshi → IP дроплета`, або переведи NS на `ns1/ns2/ns3.digitalocean.com` і став запис у Networking → Domains.
